namespace Gu.Units
{
    ...
    public struct AngleUnit : IUnit, IUnit<Angle>, IEquatable<AngleUnit>
    {
        ...
        /// Contains logic for conversion and formatting.
        /// </summary>
        public static readonly AngleUnit Radians = new AngleUnit(angle => 57.295779513082323 * angle, radians => radians / 57.295779513082323, "rad");
        /// <summary>
        /// The Degrees unit
        /// Contains conversion logic to from and formatting.
        /// </summary>
        public static readonly AngleUnit Degrees = new AngleUnit(degrees => degrees, degrees => degrees, "°");
