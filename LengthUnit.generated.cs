namespace Gu.Units
{
    ...
    public struct LengthUnit : IUnit, IUnit<Length>, IEquatable<LengthUnit>
    {
        ...
        /// <summary>
        /// Exchange Lenght to Millimeter from Inches
        /// </summary>
        /// <param name="inch">to convert</param>
        /// <returns>length in millimeter</returns>
        public double LenghtToMillimeterFromInches(double inch )
        {
            return inch / 0.03937;
        }

        /// <summary>
        /// Exchange Lenght from Millimeter to Inches
        /// </summary>
        /// <param name="millimeter">millimiter to be convert</param>
        /// <returns>length in inches</returns>
        public double LenghtFromMillimeterToInches(double millimeter)
        {
            return millimeter * 0.03937;
        }
