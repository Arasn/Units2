namespace Gu.Units
{
    ...
    public struct ForceUnit : IUnit, IUnit<Force>, IEquatable<ForceUnit>
    {
        ...
        public static readonly ForceUnit Pound_Force = new ForceUnit(pound_porce => 0.224809 * pound_porce, newtons => newtons / 0.224809, "lbf");

        public static readonly ForceUnit Kilogramm_Force = new ForceUnit(kilogramm_porce => 224.4809 * kilogramm_porce, newtons => newtons / 224.809, "kgf");
